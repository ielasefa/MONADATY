...
<Link
        ...
        >
        <span className="block font-display text-[clamp(2rem,4vw,2.75rem)] font-normal leading-[0.9] tracking-[-0.04em] text-[#C8A96A] transition-colors duration-700 group-hover:text-gold/70">
          {websiteName || "MONADATY"}
        </span>
        </Link>
              <p className="mt-5 max-w-xs text-[0.72rem] leading-[1.8] text-white/55">
                {t("brand_desc", "Crafted in Casablanca. Premium Moroccan refreshment, built around taste.")}
              </p>
