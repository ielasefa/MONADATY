...
{/* Desktop: text 45% | gap 10% | image 45% */}
<div
className="
flex flex-col items-center gap-12
lg:grid lg:min-h-[88dvh] lg:auto-rows-fr
lg:grid-cols-[45fr_10fr_45fr] lg:items-center lg:gap-0
lg:py-20
py-12
"
>
{/* ── TEXT ZONE (top on mobile, right on desktop) ── */}
<div className="order-1 flex flex-col justify-center lg:col-span-1">
<div
className={`
max-w-md
...
{/* ── PRODUCT IMAGE ZONE (bottom on mobile, left on desktop) ── */}
<div
className="
order-2
relative flex w-full max-w-[360px] items-center justify-center
lg:order-none lg:col-span-1 lg:max-w-none
"
>
...
priority
fill
sizes="(min-width: 1024px) 42vw, (min-width: 768px) 70vw, 85vw"
