  ...
  return (
    ...
    >
      <div aria-hidden="true" className="pointer-events-none absolute inset-0">
        ...
        <motion.div
          className="absolute -end-[16%] top-[-14%] h-[42rem] w-[42rem] rounded-full bg-[#D6B35A]/[0.075] blur-[160px]"
          animate={shouldReduceMotion ? undefined : { opacity: [0.58, 0.9, 0.58] }}
          transition={{ duration: 8, repeat: Infinity, ease: PREMIUM_EASE }}
        />
      ...
      <div className="relative z-10 mx-auto grid max-w-[1520px] grid-cols-1 items-center gap-10 px-5 pb-14 pt-28 sm:px-8 sm:pb-16 sm:pt-32 md:min-h-[700px] md:grid-cols-[minmax(0,0.92fr)_minmax(0,1.08fr)] md:gap-9 md:px-10 md:pb-16 md:pt-28 lg:min-h-[740px] lg:grid-cols-[minmax(0,0.88fr)_minmax(500px,1.12fr)] lg:gap-12 lg:px-16 lg:pb-20 xl:min-h-[780px] xl:px-20">
        <div className="relative z-20 max-w-[560px] text-start lg:py-10">
          <motion.div {...entrance(0.08)} className="flex items-center gap-3">
          ...
          >
            ...
            >
              ...
              <span className="h-px w-10 origin-start scale-x-70 bg-[#D6B35A]/75 transition-transform duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:scale-x-100 motion-reduce:transition-none" />
            </Link>
          </motion.div>
        ...
        <motion.div
          initial={shouldReduceMotion ? false : { opacity: 0, y: 30, scale: 0.94 }}
