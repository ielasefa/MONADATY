      ...
      >
        <div className="relative aspect-[3/4] overflow-visible">
          <button
            ...
            className={`absolute left-3 top-3 z-20 inline-flex items-center justify-center p-1.5 transition-all duration-300 ${
              isWishlisted
          ...
          <div className="relative z-10 flex h-full w-full items-center justify-center p-10 transition-all duration-[1200ms] ease-out group-hover:translate-y-[-12px]">
            {image ? (
              ...
              <div className="max-h-full max-w-full transition-transform duration-[1200ms] ease-out group-hover:scale-[1.06]">
