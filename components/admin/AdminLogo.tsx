  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className={`relative font-display ${text} font-bold leading-none text-yellow`}>
          M
        </span>
      </div>
      <span className="font-display text-xl font-bold uppercase tracking-[0.35em] text-white transition-colors group-hover:text-yellow">
        MONADATY
      </span>
    </button>
  );
