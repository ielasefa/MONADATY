...
export const DEFAULT_SITE_SETTINGS: SiteSettings = {
  ...
  footer: {
    description: "Wholesale beverages for your business.",
  ...
  hero: {
    enabled: true,
    title: "WHOLESALE\nBEVERAGES.",
    subtitle: "Drinks for Professionals — Delivered to You",
    description: "A wide range of wholesale beverages for your business, with easy ordering and delivery to you.",
    ctaText: "Order from MONADATY",
    ctaLink: "/shop",
    media: [],
  },
  featuredProducts: { enabled: true, title: "Featured", subtitle: "WHOLESALE PICKS" },
  ...
  aboutSection: { enabled: true, title: "Our Story", subtitle: "FOR PROFESSIONALS", description: "MONADATY supplies grocery stores, cafés, restaurants, snacks, hotels and resellers with the beverages their customers love: sodas, waters, juices and leading brands.\n\nOrdering is simple: browse the catalogue, place your wholesale order and receive it at your business.", image: "" },
...
export const getLandingContent = unstable_cache(
  ...
  try {
    ...
    if (!config) {
      return {
        hero: { enabled: true, title: "WHOLESALE\nBEVERAGES.", subtitle: "Drinks for Professionals — Delivered to You", description: "A wide range of wholesale beverages for your business.", ctaText: "Order from MONADATY", ctaLink: "/shop", media: [] },
        featuredProducts: { enabled: true, title: "Featured", subtitle: "WHOLESALE PICKS", productIds: "" },
        collectionsSection: { enabled: true, title: "Shop by Collection", subtitle: "THE COLLECTIONS", selectedCollectionIds: "" },
        aboutSection: { enabled: true, title: "Our Story", subtitle: "FOR PROFESSIONALS", description: "", image: "" },
        testimonialsSection: { enabled: true, title: "Testimonials", subtitle: "WHAT THEY SAY" },
        newsletter: { enabled: false, title: "Stay Updated.", subtitle: "STAY IN THE LOOP", description: "", placeholder: "Your email", buttonText: "Subscribe" },
        moroccanMoment: { enabled: true, title: "Stock. Serve. Repeat.", subtitle: "THE MONADATY MOMENT", description: "" },
        finalCta: { enabled: true, subtitle: "READY TO RESTOCK?", title: "YOUR WHOLESALE DRINKS, DELIVERED TO YOU.", description: "", buttonText: "ORDER NOW", buttonLink: "/shop" },
        seo: null,
