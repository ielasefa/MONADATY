...
export default function NotFound() {
  ...
  return (
    <div className="flex min-h-[80vh] flex-col items-center justify-center bg-black px-6 text-center" role="alert" aria-label="404 — Page not found">
      ...
      <span className="font-display text-[10rem] font-light leading-[0.85] tracking-[-0.05em] text-ivory/[0.04] md:text-[16rem]">
        404
     </span>
      ...
      <p className="mt-4 max-w-md text-[0.85rem] leading-[1.95] text-ivory/30">
