...
function AdminLoginForm() {
  ...
  const inputClass =
    "h-12 w-full rounded-input border border-white/[0.06] bg-surface px-4 text-sm text-white outline-none transition placeholder:text-muted/50 focus:border-red focus:ring-1 focus:ring-red/30 disabled:opacity-50";
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          {error && (
            <motion.div
              ...
              className="rounded-xl border border-red/20 bg-red/10 px-4 py-3 text-sm text-red" role="alert"
            >
              {error}
            </motion.div>
          )}
