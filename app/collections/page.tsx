        ...
        {largeCollection ? (
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-12" dir="ltr">
            <CollectionTile
              ...
              className="h-[430px] md:col-span-7 md:h-[600px]"
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-x-0 bottom-0 p-6 text-white sm:p-8 lg:p-10" dir="auto">
        ...
        <h2 className={`mt-3 max-w-[16ch] font-display leading-[0.94] tracking-[-0.025em] ${prominent ? "text-4xl sm:text-5xl" : "text-3xl"}`}>
          {collection.title}
        </h2>
        ...
        <span className="mt-5 inline-flex items-center gap-2 text-[0.58rem] font-semibold uppercase tracking-[0.2em] text-white/65 transition-colors duration-300 group-hover:text-gold-light">
